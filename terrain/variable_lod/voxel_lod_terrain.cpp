...
void VoxelLodTerrain::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_radius", "radius"), &Self::set_radius);
	ClassDB::bind_method(D_METHOD("get_radius"), &Self::get_radius);
	...
	ClassDB::bind_method(D_METHOD("set_cube_sphere", "enabled"), &Self::set_cube_sphere);
	ClassDB::bind_method(D_METHOD("is_cube_sphere"), &Self::is_cube_sphere);

	ClassDB::bind_method(D_METHOD("set_navigation_region", "nav_region"), &Self::set_navigation_region);
	ClassDB::bind_method(D_METHOD("get_navigation_region"), &Self::get_navigation_region);
