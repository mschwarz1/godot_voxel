#ifndef VOXEL_CUBE_SPHERE_TERRAIN_H
#define VOXEL_CUBE_SPHERE_TERRAIN_H
...
class VoxelCubeSphereTerrain : public VoxelNode {
	GDCLASS(VoxelCubeSphereTerrain, VoxelNode)
public:
