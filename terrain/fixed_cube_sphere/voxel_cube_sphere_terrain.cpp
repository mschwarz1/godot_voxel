...
VoxelCubeSphereTerrain::VoxelCubeSphereTerrain() {
	...
	callbacks.mesh_output_callback = [](void *cb_data, VoxelEngine::BlockMeshOutput &ob) {
		VoxelCubeSphereTerrain *self = reinterpret_cast<VoxelCubeSphereTerrain *>(cb_data);
...
VoxelCubeSphereTerrain::~VoxelCubeSphereTerrain() {
	ZN_PRINT_VERBOSE("Destroying VoxelCubeSphereTerrain");
	_streaming_dependency->valid = false;
	_meshing_dependency->valid = false;
	VoxelEngine::get_singleton().remove_volume(_volume_id);
}

void VoxelCubeSphereTerrain::set_material_override(Ref<Material> material) {
...
Ref<VoxelStream> VoxelCubeSphereTerrain::get_stream() const {
	return _data->get_stream();
}

void VoxelCubeSphereTerrain::set_generator(Ref<VoxelGenerator> p_generator) {
...
Ref<VoxelGenerator> VoxelCubeSphereTerrain::get_generator() const {
	return _data->get_generator();
}

// void VoxelCubeSphereTerrain::_set_block_size_po2(int p_block_size_po2) {
// 	_data_map.create(0);
// }

unsigned int VoxelCubeSphereTerrain::get_data_block_size_pow2() const {
	return _data->get_block_size_po2();
}

unsigned int VoxelCubeSphereTerrain::get_mesh_block_size_pow2() const {
	return _mesh_block_size_po2;
}

void VoxelCubeSphereTerrain::set_mesh_block_size(unsigned int mesh_block_size) {
...
void VoxelCubeSphereTerrain::_on_stream_params_changed() {
	stop_streamer();
	stop_updater();
...
void VoxelCubeSphereTerrain::_on_shadow_casting_changed() {
...
void VoxelCubeSphereTerrain::_on_render_layers_mask_changed() {
...
Ref<VoxelMesher> VoxelCubeSphereTerrain::get_mesher() const {
	return _mesher;
}

void VoxelCubeSphereTerrain::set_mesher(Ref<VoxelMesher> mesher) {
	if (mesher == _mesher) {
		return;
	}
...
void VoxelCubeSphereTerrain::get_viewers_in_area(StdVector<ViewerID> &out_viewer_ids, Box3i voxel_box) const {
...
void VoxelCubeSphereTerrain::set_collision_layer(int layer) {
...
int VoxelCubeSphereTerrain::get_collision_layer() const {
	return _collision_layer;
}

void VoxelCubeSphereTerrain::set_collision_mask(int mask) {
...
int VoxelCubeSphereTerrain::get_collision_mask() const {
	return _collision_mask;
}

void VoxelCubeSphereTerrain::set_collision_margin(float margin) {
...
float VoxelCubeSphereTerrain::get_collision_margin() const {
	return _collision_margin;
}

int VoxelCubeSphereTerrain::get_max_view_distance() const {
	return _max_view_distance_voxels;
}

void VoxelCubeSphereTerrain::set_max_view_distance(int distance_in_voxels) {
...
void VoxelCubeSphereTerrain::set_block_enter_notification_enabled(bool enable) {
...
bool VoxelCubeSphereTerrain::is_block_enter_notification_enabled() const {
	return _block_enter_notification_enabled;
}

void VoxelCubeSphereTerrain::set_area_edit_notification_enabled(bool enable) {
	_area_edit_notification_enabled = enable;
}

bool VoxelCubeSphereTerrain::is_area_edit_notification_enabled() const {
	return _area_edit_notification_enabled;
}

void VoxelCubeSphereTerrain::set_automatic_loading_enabled(bool enable) {
	_automatic_loading_enabled = enable;
}

bool VoxelCubeSphereTerrain::is_automatic_loading_enabled() const {
...
void VoxelCubeSphereTerrain::view_mesh_block(Vector3i bpos, bool mesh_flag, bool collision_flag) {
...
void VoxelCubeSphereTerrain::unview_mesh_block(Vector3i bpos, bool mesh_flag, bool collision_flag) {
	VoxelMeshBlockVT *block = _mesh_map.get_block(bpos);
...
void VoxelCubeSphereTerrain::unload_mesh_block(Vector3i bpos) {
...
const VoxelCubeSphereTerrain::Stats &VoxelCubeSphereTerrain::get_stats() const {
	return _stats;
}

void VoxelCubeSphereTerrain::set_instancer(VoxelInstancer *instancer) {
...
void VoxelCubeSphereTerrain::get_meshed_block_positions(StdVector<Vector3i> &out_positions) const {
...
Array VoxelCubeSphereTerrain::get_mesh_block_surface(Vector3i block_pos) const {
	ZN_PROFILE_SCOPE();
...
Dictionary VoxelCubeSphereTerrain::_b_get_statistics() const {
	Dictionary d;
...
void VoxelCubeSphereTerrain::stop_updater() {
...
void VoxelCubeSphereTerrain::generate_block_async(Vector3i block_position) {
...
void VoxelCubeSphereTerrain::start_streamer() {
...
void VoxelCubeSphereTerrain::stop_streamer() {
	// Invalidate pending tasks
...
void VoxelCubeSphereTerrain::clear_mesh_map() {
	if (_instancer != nullptr) {
...
void VoxelCubeSphereTerrain::reset_map() {
...
void VoxelCubeSphereTerrain::send_data_load_requests() {
	ZN_PROFILE_SCOPE();
...
void VoxelCubeSphereTerrain::consume_block_data_save_requests(BufferedTaskScheduler &task_scheduler,
...
void VoxelCubeSphereTerrain::emit_data_block_loaded(Vector3i bpos) {
...
void VoxelCubeSphereTerrain::process_viewers() {
	...
	// Update viewers
	{
		...
		for (size_t i = 0; i < _paired_viewers.size(); ++i) {
			...
			if (!VoxelEngine::get_singleton().viewer_exists(p.id)) {
				ZN_PRINT_VERBOSE(format("Detected destroyed viewer {} in VoxelCubeSphereTerrain", p.id));
		...
		struct UpdatePairedViewer {
			...
			inline void operator()(ViewerID viewer_id, const VoxelEngine::Viewer &viewer) {
				...
				if (!self.try_get_paired_viewer_index(viewer_id, paired_viewer_index)) {
					...
					ZN_PRINT_VERBOSE(format("Pairing viewer {} to VoxelCubeSphereTerrain", viewer_id));
				}
		...
		UpdatePairedViewer u{ *this, bounds_in_data_blocks, bounds_in_mesh_blocks, bounds_in_voxels,
			local_to_world_transform, world_to_local_transform, view_distance_scale };
	...
	for (size_t i = 0; i < unpaired_viewer_indexes.size(); ++i) {
		...
		ZN_PRINT_VERBOSE(format("Unpairing viewer {} from VoxelCubeSphereTerrain", _paired_viewers[vi].id));
...
bool VoxelCubeSphereTerrain::try_set_block_data(Vector3i position, std::shared_ptr<VoxelBuffer> &voxel_data) {
	ZN_PROFILE_SCOPE();
...
bool VoxelCubeSphereTerrain::has_data_block(Vector3i position) const {
...
Ref<VoxelTool> VoxelCubeSphereTerrain::get_voxel_tool() {
	Ref<VoxelTool> vt = memnew(VoxelToolCubeSphereTerrain(this));
	const int used_channels_mask = get_used_channels_mask();
...
void VoxelCubeSphereTerrain::set_run_stream_in_editor(bool enable) {
...
bool VoxelCubeSphereTerrain::is_stream_running_in_editor() const {
	return _run_stream_in_editor;
}

void VoxelCubeSphereTerrain::set_bounds(Box3i box) {
...
Box3i VoxelCubeSphereTerrain::get_bounds() const {
...
bool VoxelCubeSphereTerrain::is_area_meshed(const Box3i &box_in_voxels) const {
...
void VoxelCubeSphereTerrain::debug_set_draw_enabled(bool enabled) {
#ifdef TOOLS_ENABLED
...
bool VoxelCubeSphereTerrain::debug_is_draw_enabled() const {
#ifdef TOOLS_ENABLED
...
void VoxelCubeSphereTerrain::debug_set_draw_flag(DebugDrawFlag flag_index, bool enabled) {
#ifdef TOOLS_ENABLED
...
bool VoxelCubeSphereTerrain::debug_get_draw_flag(DebugDrawFlag flag_index) const {
#ifdef TOOLS_ENABLED
...
void VoxelCubeSphereTerrain::process_debug_draw() {
	ZN_PROFILE_SCOPE();
...
Vector3i VoxelCubeSphereTerrain::_b_voxel_to_data_block(Vector3 pos) const {
	return _data->voxel_to_block(math::floor_to_int(pos));
}

Vector3i VoxelCubeSphereTerrain::_b_data_block_to_voxel(Vector3i pos) const {
	return _data->block_to_voxel(pos);
}

Ref<VoxelSaveCompletionTracker> VoxelCubeSphereTerrain::_b_save_modified_blocks() {
...
void VoxelCubeSphereTerrain::_b_save_block(Vector3i p_block_pos) {
...
void VoxelCubeSphereTerrain::_b_set_bounds(AABB aabb) {
	ERR_FAIL_COND(!math::is_valid_size(aabb.size));
	set_bounds(Box3i(math::round_to_int(aabb.position), math::round_to_int(aabb.size)));
}

AABB VoxelCubeSphereTerrain::_b_get_bounds() const {
	const Box3i b = get_bounds();
	return AABB(b.pos, b.size);
}

bool VoxelCubeSphereTerrain::_b_try_set_block_data(Vector3i position, Ref<godot::VoxelBuffer> voxel_data) {
...
bool VoxelCubeSphereTerrain::_b_is_area_meshed(AABB aabb) const {
...
void VoxelCubeSphereTerrain::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("get_collision_mask"), &VoxelCubeSphereTerrain::get_collision_mask);
	ClassDB::bind_method(D_METHOD("set_collision_mask", "mask"), &VoxelCubeSphereTerrain::set_collision_mask);

	ClassDB::bind_method(D_METHOD("get_collision_margin"), &VoxelCubeSphereTerrain::get_collision_margin);
	ClassDB::bind_method(D_METHOD("set_collision_margin", "margin"), &VoxelCubeSphereTerrain::set_collision_margin);

	ClassDB::bind_method(D_METHOD("voxel_to_data_block", "voxel_pos"), &VoxelCubeSphereTerrain::_b_voxel_to_data_block);
	ClassDB::bind_method(D_METHOD("data_block_to_voxel", "block_pos"), &VoxelCubeSphereTerrain::_b_data_block_to_voxel);

	ClassDB::bind_method(D_METHOD("get_data_block_size"), &VoxelCubeSphereTerrain::get_data_block_size);
	...
	ClassDB::bind_method(D_METHOD("set_generator_use_gpu", "enable"), &VoxelCubeSphereTerrain::set_generator_use_gpu);
	ClassDB::bind_method(D_METHOD("get_generator_use_gpu"), &VoxelCubeSphereTerrain::get_generator_use_gpu);
	...
	ClassDB::bind_method(D_METHOD("has_data_block", "block_position"), &VoxelCubeSphereTerrain::has_data_block);
	ClassDB::bind_method(D_METHOD("is_area_meshed", "area_in_voxels"), &VoxelCubeSphereTerrain::_b_is_area_meshed);

	ClassDB::bind_method(
			D_METHOD("debug_set_draw_enabled", "enabled"), &VoxelCubeSphereTerrain::debug_set_draw_enabled);
	ClassDB::bind_method(D_METHOD("debug_is_draw_enabled"), &VoxelCubeSphereTerrain::debug_is_draw_enabled);
	ClassDB::bind_method(
			D_METHOD("debug_set_draw_flag", "flag_index", "enabled"), &VoxelCubeSphereTerrain::debug_set_draw_flag);
	ClassDB::bind_method(D_METHOD("debug_get_draw_flag", "flag_index"), &VoxelCubeSphereTerrain::debug_get_draw_flag);
