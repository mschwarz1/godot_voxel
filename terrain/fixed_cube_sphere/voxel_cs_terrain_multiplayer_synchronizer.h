#ifndef VOXEL_NETWORK_CS_TERRAIN_SYNC_H
...
class VoxelCSTerrainMultiplayerSynchronizer : public Node {
	GDCLASS(VoxelCSTerrainMultiplayerSynchronizer, Node)
public:
	VoxelCSTerrainMultiplayerSynchronizer();
