#ifndef VOXEL_TOOL_CUBE_SPHERE_TERRAIN_H
#define VOXEL_TOOL_CUBE_SPHERE_TERRAIN_H
...
class VoxelToolCubeSphereTerrain : public VoxelTool {
	GDCLASS(VoxelToolCubeSphereTerrain, VoxelTool)
public:
	VoxelToolCubeSphereTerrain();
	VoxelToolCubeSphereTerrain(VoxelCubeSphereTerrain *terrain);
	...
	static void run_blocky_random_tick_static(VoxelData &data, Box3i voxel_box,
...
private:
	...
	VoxelCubeSphereTerrain *_terrain = nullptr;
	RandomPCG _random;
};

} // namespace zylann::voxel

#endif // VOXEL_TOOL_CUBE_SPHERE_TERRAIN_H
