...
void VoxelToolCubeSphereTerrain::copy(Vector3i pos, Ref<gd::VoxelBuffer> dst, uint8_t channels_mask) const {
...
void VoxelToolCubeSphereTerrain::paste(Vector3i pos, Ref<gd::VoxelBuffer> p_voxels, uint8_t channels_mask) {
	ERR_FAIL_COND(_terrain == nullptr);
...
void VoxelToolCubeSphereTerrain::paste_masked(
...
void VoxelToolCubeSphereTerrain::run_blocky_random_tick_static(VoxelData &data, Box3i voxel_box, const VoxelBlockyLibrary &lib,
...
static Ref<VoxelBlockyLibrary> get_voxel_library(const VoxelCubeSphereTerrain &terrain) {
